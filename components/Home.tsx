    ...
    <main className="flex-grow">
      ...
      <section className="px-4 py-16 sm:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div 
            className="bg-cover bg-center flex flex-col gap-3 rounded-xl justify-end p-6 aspect-[3/2] group overflow-hidden" 
            style={{ backgroundImage: "linear-gradient(0deg, rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0) 100%), url('https://lh3.googleusercontent.com/aida-public/AB6AXuA_Kz28ITxnsIAMlfiN5Iy6bnmJZrJ-_2YscuSSNMJzJ8oEyDWXb4_qgQl-QGdZ0UVZfhuA3MMQJrfSFwLAbB5v3MJTRSXTvPplw_9-4WiYw6spF0_KmFWov7UrN1tqgZS6u1SAalqwcjro2NJGqtM5RBsEUpVDyXqdXh-yBi8L-KSDVES9ghGgXe5x9EdKMGwWvXxiycHkQBjkxLH9fw9h2vv93YGCTZmc73S9BIk08QRQMHi7YPVfTGa5vrTx9KDYCFaU1McPGKzs')" }}
          >
            <h3 className="text-white text-xl font-bold leading-tight font-serif">Luxurious Silks</h3>
            <p className="text-white/90 text-sm">Experience the unparalleled drape and sheen of our silk selection.</p>
          </div>
          <div 
            className="bg-cover bg-center flex flex-col gap-3 rounded-xl justify-end p-6 aspect-[3/2] group overflow-hidden" 
            style={{ backgroundImage: "linear-gradient(0deg, rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0) 100%), url('https://lh3.googleusercontent.com/aida-public/AB6AXuCwcJ6dCh50rnK9yZNC8sAtWIfqZuqGKISRlQGLso2MwmJ7pYjA2fLBqlKzSy36Jph_nYzdr0_pMg5Bb-JBjTtqGVcncrbIJaM5RzEkThcPovCTLDnWCqz7tUw7PbPdxt_2akjxC4Q-XNRchiKpVrw_dUb6G3M-KztVuQtA_zgF3FGmE9emcGJk_mAosvcp_eoozTf5v8RMdI4UWSbleEkLic9oiAXevAT-gTM_lTeBnpo0ulV-CccdNOlxHYY6VLR7qhgr15kmprcL')" }}
          >
            <h3 className="text-white text-xl font-bold leading-tight font-serif">Organic Linens</h3>
            <p className="text-white/90 text-sm">Discover the breathable elegance of sustainable linen fabrics.</p>
          </div>
          <div 
            className="bg-cover bg-center flex flex-col gap-3 rounded-xl justify-end p-6 aspect-[3/2] group overflow-hidden" 
            style={{ backgroundImage: "linear-gradient(0deg, rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0) 100%), url('https://lh3.googleusercontent.com/aida-public/AB6AXuApflZ2i3CT_aUAhSYt2bNbXCiz4_NSkFoiEtEY9C6pJnaMbE8HoadYrbgOoiO32_mnyVYO2qpsF1eGVnz0rwKTinb5RaVvEf-NNXCojdWJ9_MwoXVhCvyilVVjShwYm05E7XH2fktlb3b4z_Cv6JubhsiuwbNfm-OypqlmqR3bIWmK1oANGL6f7leTg0J00FAgkUSY6QrpJ3MLPPazWw7dePNCfNMtWvXe-FE4hWA3AFBCr8C5wD1WEp4sXvOAyuDUJQq4Ie7M-5Xj')" }}
          >
            <h3 className="text-white text-xl font-bold leading-tight font-serif">Sustainable Cottons</h3>
            <p className="text-white/90 text-sm">Responsibly sourced, exquisitely soft for conscious creations.</p>
          </div>
        </div>
      </section>
